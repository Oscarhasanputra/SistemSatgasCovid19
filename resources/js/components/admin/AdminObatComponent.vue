              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    name="Jenis Obat"
                    id=""
                    v-model="editDataObat.JenisObat"
                  />
                </td>
              </tr>
              <tr>
  ...
  methods: {
    ...
    simpanData: function () {
      if (isValidated(".requiredSaved"))
        Request.post("/api/obat", this.dataObat)
          .then((res) => {
            this.$router.go(0);
            // console.log(res)
          })
    ...
    simpanDataEdit: function () {
      if (isValidated(".requiredEdit"))
        Request.put("/api/obat/" + this.editDataObat.IDObat, this.editDataObat)
          .then((res) => {
            this.$router.go(0);
          })
          .catch((err) => {
