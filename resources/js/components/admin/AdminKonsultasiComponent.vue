        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table">
              ...
              <tr>
                <th>Diagnosa</th>
                <td>{{editDataKonsultasi.Diagnosa ? editDataKonsultasi.Diagnosa:"-"}}</td>
              </tr>
              <tr>
                <th>Gejala</th>
                <td>{{editDataKonsultasi.Gejala ?editDataKonsultasi.Gejala: "-"}}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>{{editDataKonsultasi.RiwayatPenyakit ?editDataKonsultasi.RiwayatPenyakit: "-"}}</td>
              </tr>
              <tr>
                <th>Konsumsi Obat</th>
                <td>{{editDataKonsultasi.KonsumsiObat ?editDataKonsultasi.KonsumsiObat: "-"}}</td>
              </tr>
              <tr>
                <th>Obat</th>
                <td>
    ...
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class="table">
              ...
              <tr>
                <th>Dokter</th>
                <td>
                  <select name="Dokter" v-model="editDataKonsultasi.IDDokter" class="requiredSave">
                      
                    <option 
                    v-for="(dokter,index) in listDokter" 
                    :key="index"
                    nama="dokter" :value="dokter.IDUser">{{dokter.Nama}}</option>
                  </select>
                </td>
              </tr>
              <tr>
                <th>Status</th>
                <td>
                  <select v-model="editDataKonsultasi.Status" class="requiredSave">
                    <option nama="dokter" value="Menunggu">Menunggu</option>
                    <option nama="dokter" value="Konsultasi">Konsultasi</option>
                    <option nama="dokter" value="Sembuh">Sembuh</option>
                    <option nama="dokter" value="Meninggal">Meninggal</option>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" @click="ajukanProses">Simpan</button>
  ...
  methods: {
    ...
    ajukanProses: function(){
        ...
        if(isValidated(".requiredSave")){
            Request.put("/api/konsultasi/"+data.IDTrTele,data).then(res=>{
                this.$router.go(0)
            })
            .catch(err=>{})
        }
