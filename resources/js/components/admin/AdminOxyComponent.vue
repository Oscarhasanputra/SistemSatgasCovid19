          ...
          <div class="modal-body">
            <table class="table">
              ...
              <tr>
                <th>Jenis Oxy</th>
                <td>
                  <select class="form-select" v-model="editDataOxy.Jenis">
              ...
              <tr>
                <th>Status</th>
                <td>
                  <select class="form-select" v-model="editDataOxy.Status">
            ...
            <table class="table">
              ...
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    name="Nama Oxygen form-control"
                    id=""
                    v-model="dataOxy.NamaOxy"
                  />
                </td>
              </tr>
              <tr>
                <th>Jenis Oxy</th>
                <td>
                  <select class="form-select" v-model="dataOxy.Jenis">
                    <option value="Oxygen">Oxygen</option>
                    <option value="Oxymeter">Oxymeter</option>
                  </select>
                </td>
              ...
              <tr>
                <th>Status</th>
                <td>
                  <select class="form-select" v-model="dataOxy.Status">
                    <option nama="dokter" value="Tersedia">Tersedia</option>
                    <option nama="dokter" value="Terpakai">Terpakai</option>
                  </select>
                </td>
  ...
  methods: {
    ...
    simpanData: function () {
      if (isValidated(".requiredSave")) {
        Request.post("/api/data/oxygen", this.dataOxy)
          .then((res) => {
            this.$router.go(0);
          })
          .catch((err) => {
    ...
    editData: function () {
      ...
      if (isValidated(".requiredEdit")) {
        Request.put(
          "/api/data/oxygen/" + this.editDataOxy.IDOxy,
          this.editDataOxy
        )
          .then((res) => {
            this.$router.go(0);
